      ...
      <div className="container mx-auto flex flex-wrap py-6">
        ...
        <aside className={`w-full md:w-1/3 flex flex-col px-3 ${isFilterOpen ? 'block' : 'hidden md:block'}`}>
          ...
          <div className="mb-4">
            ...
            <div className="mt-4">
              <a target="_blank" rel="noopener" className="inline-block" href={`https://twitter.com/intent/tweet?text=${encodeURIComponent(tweetText)}&url=https://webping.cloud`}>
                <div className="bt-tweet text-white font-medium py-2 px-4 rounded-full h-10 flex cursor-pointer">
                  <svg className="text-white mr-2" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                    <path
                      fill="currentColor"
